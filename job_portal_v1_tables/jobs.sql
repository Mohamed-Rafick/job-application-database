CREATE TABLE NewJobs (
    ...
    job_type ENUM('Full-Time', 'Part-Time', 'Remote', 'Contract') NOT NULL,  -- Type of job
...
INSERT INTO NewJobs (user_id, position, company, experience, skills, salary, location, education, job_type, last_date, updated_by, description) 
VALUES 
